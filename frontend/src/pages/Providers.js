...
function Providers() {
  ...
  const fetchProviders = React.useCallback(async () => {
    try {
      ...
      const response = await apiClient.get(
        `${API_CONFIG.ENDPOINTS.PROVIDERS}?${params}`,
        ...
        <div className="p-6">
          ...
          <div className="space-y-2 mb-4">
            {provider.primary_address && (
              <div className="flex items-center text-gray-600 text-sm">
                ...
                {provider.primary_address.city},{" "}
                {provider.primary_address.state}
            ...
            {/* Price Range Display */}
            {(provider.min_service_price != null ||
              provider.max_service_price != null) && (
              <div className="flex items-center text-gray-600 text-sm">
                ...
                <span>
                  ...
                  {provider.avg_service_price && (
                    <span className="text-gray-500 ml-1">
                      (avg: ${parseFloat(provider.avg_service_price).toFixed(0)}
                      )
                    </span>
                  )}
                </span>
          ...
          <div className="flex items-center justify-between">
            ...
            {!provider.is_claimed && (
              <button
                onClick={() =>
                  navigate(`/claim-business/${provider.id}`, {
                    state: { provider },
                  })
                }
  ...
  const ProviderListItem = ({ provider, index }) => (
    <SpotlightCard
      spotlightColor={
        index % 2 === 0
          ? "rgba(14, 165, 233, 0.25)"
  ...
  const iridescenceColor = useMemo(() => [0.6, 0.7, 1.0], []);

  return (
    <>
      {/* Iridescence Background */}
      <Iridescence
        color={iridescenceColor} // Brighter blue-purple blend
        speed={0.9}
        amplitude={0.2}
        mouseReact={true}
      />
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="text-center py-4">
                        <p className="text-gray-600">
                          ...
                          {providers.length !== 1 ? "s" : ""} on the map
                        </p>
                      </div>
                    </div>
                  ) : (
